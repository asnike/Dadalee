        ...
        <div class="col-md-10">
            ...
            <form action="" class="search-form" onsubmit="return Controller.onSubmit();" style="margin: 0;" name="priceTagForm">
                <div class="fomr-group clearfix">
                    ...
                    <div class="col-md-1"><input type="text" class="form-control input-sm" name="exclusive_size" id="exclusive_size" placeholder="{{ trans('common.exclusiveSize') }}" maxlength="2" /></div>
                    ...
                    <div class="col-md-1"><input type="text" class="form-control input-sm" name="reported_at" id="reported_at"  placeholder="{{ trans('common.reported_at') }}" maxlength="20" /></div>
