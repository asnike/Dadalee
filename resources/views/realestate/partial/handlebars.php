...
<script id="realestate-list-item" type="text/x-handlebars-template">
    <li class="list-group-item clearfix" data-id="{{ id }}">
        ...
        <div class="tools">
            ...
            <div class="btn btn-info btn-sm btn-price ladda-button" data-id="{{ id }}" data-style="zoom-in" data-size="1"><span class="ladda-label"><i class="fa fa-pencil-square-o"></i> 실거래가</span></div>
