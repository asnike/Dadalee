        ...
        Excel::create($filename.'_'.$date, function($excel) use($realestate, $filename){
            $excel->sheet($filename, function($sheet) use($realestate){
                ...
                $sheet->fromArray(array(
                    ...
                    array(trans('common.tradePrice'), $realestate->earningRate?$realestate->earningRate->price:''),
                    array(trans('common.tax'), $realestate->earningRate?$realestate->earningRate->tax:''),
                    array(trans('common.mediation_cost'), $realestate->earningRate?$realestate->earningRate->mediation_cost:''),
                    array(trans('common.judicial_cost'), $realestate->earningRate?$realestate->earningRate->judicial_cost:''),
                    array(trans('common.etc_cost'), $realestate->earningRate?$realestate->earningRate->etc_cost:''),
                    array(trans('common.sumTotal'), '=SUM(B8:B12)'),
                    array(trans('common.loan')),
                    array(trans('common.loanAmount'), $realestate->loan?$realestate->loan->amount:''),
                    array(trans('common.loanInterestRate'), $realestate->loan?(float)$realestate->loan->interest_rate/100:''),
                    array(trans('common.repayCommission'), $realestate->loan?(float)$realestate->loan->repay_commission/100:''),
                    array(trans('common.loanInterestAmount'), '=(B15*B16)/12'),
                    array(trans('common.import')),
                    array(trans('common.deposit'), $realestate->earningRate?$realestate->earningRate->deposit:''),
                    array(trans('common.monthlyFee'), $realestate->earningRate?$realestate->earningRate->monthlyfee:''),
